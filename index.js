...
client.on("message", msg => {
  ...
  if (msg.content === "$gif") {
    var dir = './assets/gifs/random/'
    let files = fs.readdirSync(dir)
    let chosenFile = files[Math.floor(Math.random() * files.length)]
    msg.channel.send({files: [dir + chosenFile]})
  }
